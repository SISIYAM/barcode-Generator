...
<body>
  <div class="wrapper">
    ...
    <div class="main-panel">
                    ...
                    <table class="table align-items-center mb-0">
                      <thead class="thead-light">
                        <tr>
                          ...
                          <th scope="col" class="text-end">Discount Type</th>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td class="text-end">
                            <button type="button" value="<?=$row['code']?>"
                              class="badge badge-success border-0 generateBarcode">Generate Barcode</button>
                          </td>
                        </tr>
                        <?php
                            $count++;
      ...
      <div class="modal fade bd-example-modal-lg" id="barcodeModal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <form class="form-horizontal" method="post" action="barcode.php" target="_blank">
              <div class="modal-body text-dark" id="printBar">
                <div id="output">
                </div>
              </div>
              <div class="modal-footer">
                <button type="button" class="btn btn-secondary closeModal" data-dismiss="modal">Close</button>
                <button type="submit" id="printBtn" class="btn btn-primary">Print</button>
              </div>
            </form>
          </div>
        </div>
